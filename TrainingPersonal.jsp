...
<script>
//var servlet='servlet/TrainingPersonalServlet';
var servlet='TrainingPersonalServlet.jsp';
...
var Nombre = 'Nombre de Persona a Registrar';
var Empresa = 'Empresa al que Pertenece';
var Ocultar = '¿Ocultar Información?';
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	...
	{view:'combo',id:'Ocultar',name:'Ocultar',value:'',placeholder:Ocultar,label:Ocultar,labelPosition:'top',required:true,yCount:'2',options:[{id:'SI',value:'SI'},{id:'NO',value:'NO'}]},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Ocultar',header:Ocultar,sort:'string',width:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	...
	Ocultar: $$('Tabla').getItem(id).Ocultar,
