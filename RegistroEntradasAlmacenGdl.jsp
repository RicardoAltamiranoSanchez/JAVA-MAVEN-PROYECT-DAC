...
var servlet='RegistroEntradasAlmacenGdlServlet.jsp';
...
var forma={view:'form',id:'Forma',width:700,height:'100%',elements:[
	{view:'text',id:'Nombre',name:'Nombre',value:'',placeholder:Nombre,label:Nombre,labelWidth:130,labelPosition:'left',required:true},	
	{view:'text',id:'Gafete',name:'Gafete',value:'',placeholder:Gafete,label:Gafete,labelWidth:130,labelPosition:'left',required:true},
