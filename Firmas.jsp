...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'text',id:'NombreFirma',name:'NombreFirma',value:'',placeholder:'<%=idiomaModulo.getProperty("NombreFirma")%>',label:'<%=idiomaModulo.getProperty("NombreFirma")%>',labelPosition:'top',attributes:{maxlength:255},required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'toolbar',id:'TablaTools',cols:[{view:'button',value:etiquetaBorrar,width:85,click:'borrar'},{view:'button',value:etiquetaModificar,width:85,click:'consultar'}]},{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,columns:[
	{id:'id',header:'ID',width:45,sort:'string'},
	{id:'NombreFirma',header:'<%=idiomaModulo.getProperty("NombreFirma")%>',fillspace:true,sort:'string'}
	]}]};
var vacio={id:'Vacio'};
