...
<script>
//var servlet='servlet/DivisionesAsignacionServlet';
var servlet='DivisionesAsignacionServlet.jsp';
...
var IdEmpleados = 'Empleado';

var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'combo',id:'IdDivisionesEmpleados',name:'IdDivisionesEmpleados',value:'',placeholder:IdDivisionesEmpleados,label:IdDivisionesEmpleados,labelWidth:100,labelPosition:'left',options:[],yCount:'3',required:true},
	{view:'combo',id:'IdEmpleados',name:'IdEmpleados',value:'',placeholder:IdEmpleados,label:IdEmpleados,labelWidth:100,labelPosition:'left',options:[],yCount:'3',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'IdDivisionesEmpleados',header:'IdDE',fillspace:true,sort:'string',minWidth:50},
	{id:'NombreDivisionesEmpleados',header:'División',fillspace:true,sort:'string',width:400},
	{id:'IdEmpleados',header:'Id Empleado',sort:'string',width:50},
	{id:'NombreEmpleados',header:'Nombre Empleado',sort:'string',width:400}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	IdDivisionesEmpleados: $$('Tabla').getItem(id).IdDivisionesEmpleados,
...
var servletIdEmpleados='servlet/EmpleadosServlet';var listaIdEmpleados=$$('IdEmpleados').getPopup().getList();listaIdEmpleados.clearAll();listaIdEmpleados.load(servletIdEmpleados + '?Accion=getEmpleados&filter[value]=');
