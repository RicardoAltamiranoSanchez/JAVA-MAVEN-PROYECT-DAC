...
<script>
//var servlet='servlet/RegistroSalidasAlmacenGdlServlet';
var servlet='RegistroSalidasAlmacenGdlServlet.jsp';
...
var forma={view:'form',id:'Forma',width:700,height:'100%',elements:[
	...
	{cols:[
		{view:'label',id:'etiquetaGuia',name:'etiquetaGuia',label:Guia,hidden:true},
		{cols:[
			{},
			{view:'combo',id:'Prefijo',name:'Prefijo',value:'',hidden:true,required:false,yCount:'2',options:[{id:'A02',value:'A02'},{id:'036',value:'036'}]},
		]},
		{view:'text',id:'Awb',name:'Awb',value:'',placeholder:Guia,attributes:{maxlength:8},hidden:true,required:false},
		{},
		{},
		{},
	]},
	{view:'textarea',id:'Observaciones',name:'Observaciones',value:'',placeholder:Observaciones,label:Observaciones,labelWidth:100,labelPosition:'left',hidden:true,required:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'IdRegistroEntradasAlmacenGdl',header:'Se le dio Salida a',fillspace:true,sort:'string',minWidth:150},
	{id:'Prefijo',header:Prefijo,sort:'string',width:40},
	{id:'Awb',header:Awb,sort:'string',width:70},
	{id:'FechaHora',header:'Hora de Salida',sort:'string',width:88},
]}]};
var vacio={id:'Vacio'};

webix.ui({id:'principal',type:'space',rows:[{view:'toolbar',cols:[{},{view:'button',id:'BotonBorrar',value:etiquetaBotonBorrar,width:85,hidden:true,click:'borrar'},{view:'text',id:'CampoBuscar',name:'CampoBuscar',value:'',placeholder:etiquetaBotonBuscar,width:300},{view:'button',id:'BotonBuscar',value:etiquetaBotonBuscar,width:85,click:'buscar'}]},{view:'accordion',type:'wide',multi:true,height:'100%',cols:[{body:tabla},{header:' ',body:forma}]}]});
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	IdRegistroEntradasAlmacenGdl: $$('Tabla').getItem(id).IdRegistroEntradasAlmacenGdl,
	Prefijo: $$('Tabla').getItem(id).Prefijo,
	Awb: $$('Tabla').getItem(id).Awb,
