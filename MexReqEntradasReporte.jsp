...
<script>
var servlet='MexReqEntradasServlet.jsp';
...
{view:'toolbar',cols:[{view:'button',id:'BotonExcel2',value:'EXCEL',width:85, click:'excel'},{},{view:'button',id:'BotonPdf',value:'RECHAZAR',width:85, click:'rechazar'},{view:'button',id:'BotonExcel',value:'FACTURAS',width:85, click:'autorizar'}]},
...
function autorizar() {
	...
	webix.ui({view:"window",id:'VentanaAutorizar',width:600,height:400,position:'center',modal:true,head:{cols:[{},{view:'button', label:'X', width:50, click:("$$('VentanaAutorizar').close();")}]},
		body:{rows:[
			{view:'label',id:'titulo',label:'ANEXA TU FACTURA PDF Y XML',align:'left'},
			{view:'iframe',id:'Ventana1',src:'MexReqFacturas.jsp?IdGenerado=' + id},
			{cols:[
