...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Archivo',header:'Archivo',fillspace:true,sort:'string',minWidth:350,template:'<a href="formatosSeguridad/#Archivo#" target="#Archivo#">#Archivo#</a>'}
]}]};
var vacio={id:'Vacio'};
...
function buscar(){
	...
	}valoresBusqueda={Accion:'BuscarFiltrado',Campo:$$('CampoBuscar').getValue()};enviar(resultadosEncontrados,'Buscar');}
