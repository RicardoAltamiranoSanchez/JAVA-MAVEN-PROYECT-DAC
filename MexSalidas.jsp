...
<script>
//var servlet='servlet/MexSalidasServlet';
var servlet='MexSalidasServlet.jsp';
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	...
	{view:'text',id:'Aplicacion',name:'Aplicacion',value:'',placeholder:Aplicacion,label:Aplicacion,labelWidth:100,labelPosition:'left',required:true},
	{view:'text',id:'Comentarios',name:'Comentarios',value:'',placeholder:Comentarios,label:Comentarios,labelWidth:100,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Aplicacion',header:Aplicacion,sort:'string',width:150},
	{id:'Comentarios',header:Comentarios,sort:'string',width:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	IdEntradas: $$('Tabla').getItem(id).IdEntradas,
	...
	Aplicacion: $$('Tabla').getItem(id).Aplicacion,
...
$$('Aplicacion').attachEvent('onChange',function(nuevo,anterior){nuevo=nuevo.toUpperCase();$$('Aplicacion').setValue(nuevo);});
