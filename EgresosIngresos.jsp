...
<script>
//var servlet='servlet/EgresosIngresosServlet';
var servlet='EgresosIngresosServlet.jsp';
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Concepto',header:Concepto,sort:'string',width:150},
...
function guardarFinal(){if(modoSubforma){$$('BotonGuardar').hide();ultimosCapturados(datosGuardados);setSubforma();}else{inicial();ultimosCapturados(datosGuardados);}}
