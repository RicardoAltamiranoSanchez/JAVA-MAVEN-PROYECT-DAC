...
<%@ page import="Utilerias.Cantidades" %><%@ page import="Objetos.RegistroEntradasAlmacenGdl" %>
...
MysqlPool eDB;
ResultSet datos;
RegistroEntradasAlmacenGdl objeto;
eDB = new MysqlPool();
eDB.setConexion();
...
datos = eDB.getQuery("select A.Id, A.Nombre, A.Gafete, A.FechaHora as FechaHoraEntrada, B.Prefijo, B.Awb, B.Observaciones, B.FechaHora as FechaHoraSalida, CONCAT(Timediff(B.FechaHora,A.FechaHora),'') as TiempoAlmacen"+ 
		...
		" and A.Nombre like if(@1:=(select Nombre from RegistroEntradasAlmacenGdl where Id='"+request.getParameter("IdRegistroEntradasAlmacenGdl")+"') is null,('%%'),(select Nombre from RegistroEntradasAlmacenGdl where Id='"+request.getParameter("IdRegistroEntradasAlmacenGdl")+"'))"+ // FUNCIONA
		" and A.FechaHora >= if(@1:=('"+request.getParameter("AuxFecha")+"') = 'vacio',('1900-01-01 00:00:00'),('"+request.getParameter("AuxFecha")+" 00:00:00'))" +
		" and A.FechaHora <= if(@1:=('"+request.getParameter("FechaA")+"') is null,('9999-12-31 00:00:00'),('"+request.getParameter("FechaA")+" 00:00:00'))"); // FUNCIONA
