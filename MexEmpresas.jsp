...
<script>
//var servlet='servlet/MexEmpresasServlet';
var servlet='MexEmpresasServlet.jsp';
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'text',id:'Empresa',name:'Empresa',value:'',placeholder:Empresa,label:Empresa,labelWidth:100,labelPosition:'left',required:true},
	{view:'text',id:'Rfc',name:'Rfc',value:'',placeholder:Rfc,label:Rfc,labelWidth:100,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Empresa',header:Empresa,fillspace:true,sort:'string',minWidth:150},
	{id:'Rfc',header:Rfc,sort:'string',width:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	Empresa: $$('Tabla').getItem(id).Empresa,
