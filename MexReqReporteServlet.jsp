...
try {
	...
	if(request.getParameter("Accion").equals("Buscar") || request.getParameter("Accion").equals("Requisicion") || request.getParameter("Accion").equals("VistoBueno") 
		...
		if(request.getParameter("Accion").equals("Requisicion")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
					
					sentencia.executeUpdate("update MexRequerimientos set Estatus = '', Bloquear = 'false' where Id = '" + ids[i].getId() + "'");
					...
					sentencia.executeUpdate("update MexReqProductos set Estatus = '', Bloquear = 'false' where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = '', Bloquear = 'false' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = '', Bloquear = 'false' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
				
			}
		}
		else if(request.getParameter("Accion").equals("VistoBueno")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
					
					sentencia.executeUpdate("update MexRequerimientos set Estatus = 'VoBo', Bloquear = 'true' where Id = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids[i].getId() + "'");
					
					sentencia.executeUpdate("update MexReqProductos set Estatus = 'VoBo', Bloquear = 'true' where IdRequerimientos = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = 'VoBo', Bloquear = 'true' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = 'VoBo', Bloquear = 'true' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
	
			}
		}
		else if(request.getParameter("Accion").equals("PreAutorizar")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
			...
			try {
				...
				for(int i = 0; i < ids.length; i++) {
					...
					sentencia.executeUpdate("update MexRequerimientos set Estatus = 'Autorizar', Bloquear = 'true' where Id = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids[i].getId() + "'");
					
					sentencia.executeUpdate("update MexReqProductos set Estatus = 'Autorizar', Bloquear = 'true' where IdRequerimientos = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = 'Autorizar', Bloquear = 'true' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = 'Autorizar', Bloquear = 'true' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
	
			}
		}
		else if(request.getParameter("Accion").equals("Compras")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
					
					sentencia.executeUpdate("update MexRequerimientos set Estatus = 'OrdenCompra', Bloquear = 'true' where Id = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids[i].getId() + "'");
					
					sentencia.executeUpdate("update MexReqProductos set Estatus = 'OrdenCompra', Bloquear = 'true' where IdRequerimientos = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = 'OrdenCompra', Bloquear = 'true' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = 'OrdenCompra', Bloquear = 'true' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
	
			}
		}
		else if(request.getParameter("Accion").equals("Facturacion")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
					
					sentencia.executeUpdate("update MexRequerimientos set Estatus = 'Entradas', Bloquear = 'true' where Id = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids[i].getId() + "'");
					
					sentencia.executeUpdate("update MexReqProductos set Estatus = 'Entradas', Bloquear = 'true' where IdRequerimientos = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = 'Entradas', Bloquear = 'true' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = 'Entradas', Bloquear = 'true' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
	
			}
		}
		else if(request.getParameter("Accion").equals("ParteContable")) {
			gson = new Gson();
			try {
				MexReqFinalizados[] ids = gson.fromJson(request.getParameter("Ids"), MexReqFinalizados[].class);
				for(int i = 0; i < ids.length; i++) {
					
					sentencia.executeUpdate("update MexRequerimientos set Estatus = 'EntradasAdmon', Bloquear = 'true' where Id = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids[i].getId() + "'");
					
					sentencia.executeUpdate("update MexReqProductos set Estatus = 'EntradasAdmon', Bloquear = 'true' where IdRequerimientos = '" + ids[i].getId() + "'");
					sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids[i].getId() + "'");
				...
				sentencia.executeUpdate("update MexRequerimientos set Estatus = 'EntradasAdmon', Bloquear = 'true' where Id = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexRequerimientosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,Fecha,IdPara,IdProveedores,Justificacion,IdEmpresas,IdAreas,IdUnidades from MexRequerimientos where Id = '" + ids.getId() + "'");
				
				sentencia.executeUpdate("update MexReqProductos set Estatus = 'EntradasAdmon', Bloquear = 'true' where IdRequerimientos = '" + ids.getId() + "'");
				sentencia.executeUpdate("insert into MexReqProductosApoyo (Quien,Registro,Borrar,IdOrigen,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra) select '" + session.getAttribute("IdUsuario") + "',now(),'Si',Id,U,G,E,Bloquear,IdRequerimientos,Cantidad,Producto,Unidad,Precio,Estatus,IdOrdenCompra from MexReqProductos where IdRequerimientos = '" + ids.getId() + "'");
