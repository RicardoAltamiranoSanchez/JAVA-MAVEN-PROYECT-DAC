...
<script>
//var servlet='servlet/NotificacionesPabloServlet';
var servlet='NotificacionesPabloServlet.jsp';
...
var IdUsuarios = 'Notificar al Sr Pablo la falta autorizada para';
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'IdUsuarios',header:IdUsuarios,fillspace:true,sort:'string',minWidth:150}
]}]};
var vacio={id:'Vacio'};
...
//var servletIdUsuarios='UsuariosServlet.jsp';var listaIdUsuarios=$$('IdUsuarios').getPopup().getList();listaIdUsuarios.clearAll();listaIdUsuarios.load(servletIdUsuarios + '?Accion=getUsuarios&filter[value]=');
var listaIdUsuarios=$$('IdUsuarios').getPopup().getList();listaIdUsuarios.clearAll();listaIdUsuarios.load("servlet/EmpleadosServlet?Accion=getUsuariosDiv&filter[value]=");
