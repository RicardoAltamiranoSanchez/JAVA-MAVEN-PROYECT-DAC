...
<script>
//var servlet='servlet/MonedasServlet';
var servlet='MonedasServlet.jsp';
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'text',id:'Moneda',name:'Moneda',value:'',placeholder:Moneda,label:Moneda,labelWidth:100,labelPosition:'left',required:true},
	{view:'text',id:'Clave',name:'Clave',value:'',placeholder:Clave,label:Clave,labelWidth:100,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Moneda',header:Moneda,fillspace:true,sort:'string',minWidth:150},
	{id:'Clave',header:Clave,sort:'string',width:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Moneda').attachEvent('onChange',function(nuevo,anterior){nuevo=nuevo.toUpperCase();$$('Moneda').setValue(nuevo);});
