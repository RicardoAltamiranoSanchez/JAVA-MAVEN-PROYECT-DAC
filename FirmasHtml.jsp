...
var forma={view:'form',id:'Forma',width:800,height:'100%',scroll:"y",elements:[
	...
	{view:'tinymce-editor',id:'HtmlFirma',name:'HtmlFirma',value:'',placeholder:'<%=idiomaModulo.getProperty("HtmlFirma") %>',label:'<%=idiomaModulo.getProperty("HtmlFirma") %>',height:400,config:{plugins:'table,textcolor,hr,code',toolbar:'newdocument, bold, italic, underline, alignleft, aligncenter, alignright, alignjustify, styleselect, fontselect, fontsizeselect, bullist, numlist, outdent, indent, backcolor, removeformat, undo, redo'}},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'toolbar',id:'TablaTools',cols:[{view:'button',value:etiquetaBorrar,width:85,click:'borrar'},{view:'button',value:etiquetaModificar,width:85,click:'consultar'}]},{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,columns:[
	{id:'IdFirmas',header:'<%=idiomaModulo.getProperty("IdFirmas")%>',fillspace:true,sort:'string'},
	{id:'HtmlFirma',header:'<%=idiomaModulo.getProperty("HtmlFirma")%>',sort:'string'}]}]};
var vacio={id:'Vacio'};
