...
var forma={view:'form',id:'Forma',elements:[
	...
	{cols:[{},
		{view:'combo',id:'Pago',name:'Pago',width:170,height:22,value:'',placeholder:Pago,label:Pago,labelWidth:60,labelPosition:'left',options:["Pendiente","Parcial","Total"],yCount:'3',required:true},
		{view:'text',id:'MontoPago',name:'MontoPago',width:120,height:22,value:'',placeholder:MontoPago,label:'',labelWidth:100,labelPosition:'left',required:true,readonly:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Pago',header:Pago,fillspace:true,sort:'string',minWidth:150},
	{id:'MontoPago',header:MontoPago,fillspace:true,sort:'string',minWidth:150},
