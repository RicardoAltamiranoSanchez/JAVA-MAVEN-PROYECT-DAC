...
<script>
var servlet='MexReqEntradasAdmonServlet.jsp';
...
{view:'toolbar',cols:[{view:'button',id:'BotonExcel2',value:'EXCEL',width:85, click:'excel'},{},{view:'button',id:'BotonPdf',value:'RECHAZAR',width:85, click:'rechazar'},{view:'button',id:'BotonExcel',value:'PAGOS',width:85, click:'autorizar'}]},
...
function autorizar() {
	var id=$$('Tabla').getSelectedId();
	webix.ui({view:"window",id:'VentanaAutorizar',width:600,height:400,position:'center',modal:true,head:{cols:[{},{view:'button', label:'X', width:50, click:("$$('VentanaAutorizar').close();")}]},
		body:{rows:[
			{view:'label',id:'titulo',label:'ANEXA TU COMPROBANTE DE PAGO',align:'left'},
			{view:'iframe',id:'Ventana1',src:'MexReqPagos.jsp?IdGenerado=' + id},
			{cols:[
				{},{view:'button',id:'BotonAutorizar2',value:'CONFIRMAR',width:85, click:'autorizar2'}
			]}
		]}}
	).show();
}
function autorizar2(){
	...
	$$('Forma').setValues({Accion:'Autorizar',Ids:ids},true);
	enviar('Autorizar','Autorizar');
	$$('VentanaAutorizar').close();
}
function rechazar() {
