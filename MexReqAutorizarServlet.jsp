...
<%@ page import="Objetos.MexReqAutorizar"%>
...
private void imprimeJson(HttpServletResponse response, MexReqAutorizar objeto) throws IOException {
...
private void imprimeJson(HttpServletResponse response, ArrayList<MexReqAutorizar> objeto) throws IOException {
	response.setContentType("application/json");
	PrintWriter out = response.getWriter();
	gson = new Gson();
	out.println(gson.toJson(objeto));
...
private void armaLog(MexReqAutorizar objeto, Exception e) {
	objeto.setError(true);
	fechas = new Fechas();
	StringBuffer log = new StringBuffer();
	log.append("Serie:");
	log.append("MexReqAutorizarServlet.jsp");
	log.append(" Evento:");
...
try {
	...
	if(request.getParameter("Accion").equals("Buscar") || request.getParameter("Accion").equals("Autorizar") || request.getParameter("Accion").equals("Rechazar")) {
		if(request.getParameter("Accion").equals("Autorizar")) {
			gson = new Gson();
			try {
				MexReqAutorizar[] ids = gson.fromJson(request.getParameter("Ids"), MexReqAutorizar[].class);
		...
		resultados = sentencia.executeQuery("select A.* from MexReqAutorizar as A" + whereInicio + where.toString());
		ArrayList<MexReqAutorizar> info = new ArrayList<MexReqAutorizar>();
		while(resultados.next()) {
			...
			objeto.setPrincipal(resultados.getString("Principal"));
			info.add(objeto);
		}
