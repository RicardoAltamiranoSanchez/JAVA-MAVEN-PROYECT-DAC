...
<script>
var nada='';var valoresBusqueda='';var idGenerado='';var campo='IdAreas';
...
var forma={view:'form',id:'Forma',elements:[
	{view:'text',id:'IdAreas',name:'IdAreas',value:'',placeholder:IdAreas,label:IdAreas,labelWidth:100,labelPosition:'left',hidden:true},
