...
var forma={view:'form',id:'Forma',elements:[
	...
	{view:'uploader',id:'Archivo',name:'Archivo',value:'',link:'mylist',placeholder:'Archivo',label:'Archivo',upload:'SubirTrainingArchivosServlet.jsp',autosend:true,required:true,multiple:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'IdTraining',header:IdTraining,fillspace:true,sort:'string',minWidth:150},
	{id:'Archivo',header:Archivo,sort:'string',width:150,template:'<a href="training/#value#" target="Archivo#id#">#Archivo#</a>'},
]}]};
var vacio={id:'Vacio'};
