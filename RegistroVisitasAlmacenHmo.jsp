...
<script>
//var servlet='servlet/RegistroEntradasAlmacenHmoServlet';
...
//DEFINIENDO FORMAS
	...
	var formaacc={view:'form',id:'FormaAcc',width:'100%',height:'100%',elements:[
		...
		{cols:[
			{rows:[
				{view:'text',id:'Nombre',name:'Nombre',value:'',placeholder:Nombre,label:'<font size ="3"><font color="black"><strong>Favor de registrar su Nombre o Empresa a dar acceso</font color="red"></strong></font size ="3">',labelWidth:130,width:600,height:100,labelPosition:'top',required:true},	
				{view:'text',id:'Gafete',name:'Gafete',value:'',placeholder:Gafete,label:'<font size ="3"><font color="black"><strong>Registre el Gafete que se le asignó</font color="red"></strong></font size ="3">',labelWidth:130,width:600,height:100,labelPosition:'top',required:true},
				//Aquí se define de forma constante la estacion, en este caso HMO
				{view:'text',id:'EstacionEnt',name:'Estacion',value:'HMO',placeholder:'Estacion',label:'Estacion',labelWidth:130,width:1100,height:100,labelPosition:'top',required:false,hidden:true},
			]},
	...
	var formasal1={view:'form',id:'FormaSal1',width:'100%',height:'100%',elements:[
			{rows:[
				...
				/* {view:'combo',id:'IdRegistroEntradasAlmacenHmo',name:'IdRegistroEntradasAlmacenHmo',value:'',placeholder:IdRegistroEntradasAlmacenHmo,label:IdRegistroEntradasAlmacenHmo,labelWidth:100,labelPosition:'left',options:[],yCount:'3',required:true}, */
					{view:"label", 
	...
	var formachec={view:'form',id:'FormaChec',width:'100%',height:'100%',elements:[
		//Estacion
		{view:"label", 
		    label: "<span style='font-size:80px; color:red;font-family:verdana;font-style:bold'>HMO</span>", 
		    height:125,
		    align:"center"},
		    
		// Personal interno
	    {view:"label", 
		    label: "<span style='font-size:30px; color:green;font-family:verdana;font-style:bold'>PERSONAL INTERNO</span>", 
		    height:40,
		    align:"center"},
		
		 // Relój checador
	    {view:"label", 
		    label: "<span style='font-size:30px; color:red;font-family:verdana;font-style:bold'>RELOJ CHECADOR</span>", 
		    height:40,
		    align:"center"},
		 // Relój
	    {view:"label",id:"Reloj",
		    label: "<span style='font-size:50px; color:black;font-family:verdana;font-style:bold'>16:43</span>",
		    height:130,
		    align:"center"},
		//Número de Empleado  
		{view:"label",
	  ...
	  //Botones
    	{rows:[
	    	...
	    	{cols:[
	    		{},
	    		{},
	    		{view:'button',id:'BotonEntradaChec',type:'image',value:'',width:140,height:140,click:'guardarentradachec',image:'imagenes/BtnEntradaChec140.png'},
	    		{},
	    		{view:'button',id:'BotonSalidaChec',type:'image',value:'',width:140,height:140,click:'guardarsalidachec',image:'imagenes/BtnSalidaChec140.png'},
	    		{},
	    		{},
	    		{},
	    		{},
	    		{},
	    		{view:'button',id:'BotonEntComChec',type:'image',value:'',width:140,height:140,click:'guardarentcomchec',image:'imagenes/BtnEntComChec140.png'},
	    		{},
	    		{view:'button',id:'BotonSalComChec',type:'image',value:'',width:140,height:140,click:'guardarsalcomchec',image:'imagenes/BtnSalComChec140.png'},
	    		{},
	    		{},
	    	]},
    	]},
		...
		{view:'text',id:'EstacionChec',name:'Estacion',value:'HMO',placeholder:'Estacion',label:'Estacion',labelWidth:130,width:1100,height:100,labelPosition:'top',required:false,hidden:true},
	]};
...
var formasal2={view:'form',id:'FormaSal2',width:800,height:800,elements:[
	...
	{view:'text',id:'EstacionSal',name:'Estacion',value:'HMO',placeholder:'Estacion',label:'Estacion',labelWidth:130,width:1100,height:100,labelPosition:'top',required:false,hidden:true},
...
//FUNCIONES DE FORMAS
function inicial(){for(var i=1;i<variablesFijas.length;i++){$$(variablesFijas[i].campo).setValue(variablesFijas[i].valor);}/*DEFINIENDO SIEMPRE ESTACION AQUI*/$$('EstacionEnt').setValue('HMO');$$('EstacionSal').setValue('HMO');if(modoSubforma){$$('FrameSubforma').hide();}}
...
//Checador
//function guardarentradachec(){$$('FormaChec').setValues({Accion:'GuardarEntrada'},true);if($$('FormaChec').validate()){enviarchec(datosGuardados,'GuardarEntrada');webix.alert('Se registró el Acceso del Número de Empleado: '+$$('NumEmpleado').getValue());$$('FormaChec').clear();$$('EstacionChec').setValue('HMO');}}
...
function guardarentradachec(){$$('FormaChec').setValues({Accion:'GuardarEntrada'},true);if($$('FormaChec').validate()){enviarchec(datosGuardados,'GuardarEntrada');$$('FormaChec').clear();$$('EstacionChec').setValue('HMO');}}
...
function guardarsalidachec(){$$('FormaChec').setValues({Accion:'GuardarSalida'},true);if($$('FormaChec').validate()){enviarchec(datosGuardados,'GuardarSalida');/*webix.alert("<span style='font-size:30px; color:red;font-family:verdana;font-style:bold'>Salida Registrada</span>");*/$$('FormaChec').clear();$$('EstacionChec').setValue('HMO');}}

function guardarentcomchec(){$$('FormaChec').setValues({Accion:'GuardarEntradaComida'},true);if($$('FormaChec').validate()){enviarchec(datosGuardados,'GuardarEntradaComida');$$('FormaChec').clear();$$('EstacionChec').setValue('HMO');}}
function guardarsalcomchec(){$$('FormaChec').setValues({Accion:'GuardarSalidaComida'},true);if($$('FormaChec').validate()){enviarchec(datosGuardados,'GuardarSalidaComida');$$('FormaChec').clear();$$('EstacionChec').setValue('HMO');}}
...
//BLOQUEADO, FUNCIONA COMBO
/* $$('IdRegistroEntradasAlmacenHmo').attachEvent("onItemClick", function(id, e){
    //code
	var servletIdRegistroEntradasAlmacenHmo='RegistroEntradasAlmacenHmoServlet.jsp';var listaIdRegistroEntradasAlmacenHmo=$$('IdRegistroEntradasAlmacenHmo').getPopup().getList();listaIdRegistroEntradasAlmacenHmo.clearAll();listaIdRegistroEntradasAlmacenHmo.load(servletIdRegistroEntradasAlmacenHmo + '?Accion=getIdRegistroEntradasAlmacenHmoActivos&filter[value]=');
	//$$('VentanaFormaSal2').show();
}); */

    //code
function cargaSalidas(){$$('BotonesSalidas').clearAll();$$('BotonesSalidas').load('RegistroEntradaVisitasAlmacenesServlet.jsp?Accion=getIdRegistroEntradasAlmacenesActivosEst&filter[value]=,HMO');}
//$$('VentanaFormaSal2').show();
cargaSalidas();
activaReloj();
...
//RegistroEntradasAlmacenHmo.jsp
%>