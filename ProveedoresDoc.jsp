...
var forma={view:'form',id:'Forma',elements:[
	...
	{cols:[
		...
		{cols:[
			{view:'uploader',id:'Archivo',name:'Archivo',value:'',link:'listaArchivo',placeholder:Archivo,label:Archivo,labelWidth:100,labelPosition:'left',required:true,upload:'ProveedoresSubirDoc.jsp',autosend:true,multiple:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Archivo',header:Archivo,sort:'string',fillspace:true,sort:'string',minWidth:150,template:'<a href="proveedores/#Archivo#" target="#Archivo#">#Archivo#</a>'}
]}]};
var vacio={id:'Vacio'};
