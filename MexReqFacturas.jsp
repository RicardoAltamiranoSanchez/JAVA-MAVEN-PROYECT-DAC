...
var forma={view:'form',id:'Forma',elements:[
	...
	{cols:[
		{view:'text',id:'Nombre',name:'Nombre',value:'',placeholder:Nombre,label:Nombre,labelWidth:70,labelPosition:'left',required:true},
		{view:'uploader',id:'Archivo',name:'Archivo',value:'',link:'listaArchivo',placeholder:Archivo,label:Archivo,labelWidth:100,labelPosition:'left',required:true,upload:'MexSubirFacturasServlet.jsp',autosend:true,multiple:false},
