...
<script>
//var servlet='servlet/MexEmpresasAreasServlet';
var servlet='MexEmpresasAreasServlet.jsp';
var nada='';var valoresBusqueda='';var idGenerado='';var archivo='MexEmpresasUnidades.jsp';var modoSubforma=true;
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'text',id:'Area',name:'Area',value:'',placeholder:Area,label:Area,labelWidth:100,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Area',header:Area,fillspace:true,sort:'string',minWidth:150}
]}]};
var vacio={id:'Vacio'};
