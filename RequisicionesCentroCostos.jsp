...
<script>
//var servlet='servlet/RequisicionesCentroCostosServlet';
var servlet='RequisicionesCentroCostosServlet.jsp';
...
var IdUsuarios = 'Usuario'.toUpperCase();
var CentroCosto = 'Centro de Costo'.toUpperCase();

var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'combo',id:'IdUsuarios',name:'IdUsuarios',value:'',placeholder:IdUsuarios,label:IdUsuarios,labelWidth:100,labelPosition:'left',options:[],yCount:'3',required:true},
	{view:'text',id:'CentroCosto',name:'CentroCosto',value:'',placeholder:CentroCosto,label:CentroCosto,labelWidth:100,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'IdUsuarios',header:IdUsuarios,sort:'string',width:150},
	{id:'CentroCosto',header:CentroCosto,fillspace:true,sort:'string',minWidth:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	IdUsuarios: $$('Tabla').getItem(id).IdUsuarios,
	CentroCosto: $$('Tabla').getItem(id).CentroCosto,
...
var listaIdUsuarios=$$('IdUsuarios').getPopup().getList();listaIdUsuarios.clearAll();listaIdUsuarios.load("servlet/GerentesServlet?Accion=getGerentes&filter[value]=");
$$('CentroCosto').attachEvent('onChange',function(nuevo,anterior){nuevo=nuevo.toUpperCase();$$('CentroCosto').setValue(nuevo);});
