...
<script>
//var servlet='servlet/MexReqVoBoReporteServlet';
var servlet='MexReqVoBoServlet.jsp';
...
{view:'toolbar',cols:[{view:'button',id:'BotonExcel2',value:'EXCEL',width:85, click:'excel'},{},{view:'button',id:'BotonPdf',value:'RECHAZAR',width:85, click:'rechazar'},{view:'button',id:'BotonExcel',value:'VISTO BUENO',width:85, click:'autorizar'}]},
...
function autorizar() {
	webix.confirm({title:'VoBo',ok:si,cancel:no,type:'confirm-error',text:'VoBo a las requisiciones seleccionadas?',callback:function(result){if(result){var ids=$$('Tabla').getSelectedId();if(ids == null){webix.message(seleccioneUnRegistro);$$('Mensaje').setValue('<font color="blue"><strong>'+seleccioneUnRegistro+'</strong></font>');}else{$$('Forma').setValues({Accion:'Autorizar',Ids:ids},true);enviar('Autorizar','Autorizar');}}else{$$('Tabla').clearSelection();}}});
}
