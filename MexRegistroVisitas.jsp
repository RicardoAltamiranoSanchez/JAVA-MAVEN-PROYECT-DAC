...
var servletacc='MexRegistroEntradasAlmacenServlet.jsp';
var servletsal='MexRegistroSalidasAlmacenServlet.jsp';
...
var IdMexRegistroEntradasAlmacen = 'Seleccione a quien le dará salida';
var Prefijo = 'Prefijo';
var Awb = 'Awb';
...
var formasal2={view:'form',id:'FormaSal2',width:800,height:800,elements:[
	{view:'text',id:'IdMexRegistroEntradasAlmacen',name:'IdMexRegistroEntradasAlmacen',value:'',placeholder:Guia,attributes:{maxlength:8},hidden:true,required:false},
	...
	{cols:[
		...
		{cols:[
			{},
			{view:'text',id:'Prefijo',name:'Prefijo',value:'',placeholder:'DAC',required:false,yCount:'2',attributes:{maxlength:3}},
		]},
...
function cargaSalidas(){$$('BotonesSalidas').clearAll();$$('BotonesSalidas').load('MexRegistroEntradasAlmacenServlet.jsp?Accion=getIdMexRegistroEntradasAlmacenActivos&filter[value]=');}

cargaSalidas();

$$('BotonesSalidas').attachEvent('onSelectChange', function(id){
	$$('VentanaFormaSal2').show();
	$$('IdMexRegistroEntradasAlmacen').setValue(parseInt(id));
});
