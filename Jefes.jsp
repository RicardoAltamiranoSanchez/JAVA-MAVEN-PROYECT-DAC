...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'combo',id:'IdUsuario',name:'IdUsuario',value:'',placeholder:'<%=idiomaModulo.getProperty("IdUsuario") %>',label:'<%=idiomaModulo.getProperty("IdUsuario") %>',required:true,options:[],yCount:'3'},
...
var vacio={id:'Vacio'};
webix.ui({id:'principal',type:'space',rows:[{type:'header', template:'JEFES'},{view:'accordion',type:'wide',multi:true,height:'100%',cols:[{header:' ',body:forma},{animate:{type:'flip'},cells:[vacio,lista,tabla]}]}]});	
