...
.Apartado{
	position: relative;
  	...
  	left: 6%;
  	overflow: scroll;
  	/* Padding-right:1000px;  /* haciendo invisible el scroll */
  	text-align:justify;
}
</style>
<div id="contenedor" class="texto">
	...
	<div id="contenido">
		...
		if (Admon.equals("MEX")){
		%>
			<img src="imagenes/DAC_LATERAL.png" id="McsLateral"></img>
			<img src="imagenes/2021_Logo_DAC_Politicas.png" width="1" height="1" id="McsLogo"></img>
		<%
		}else{
		%>
		...
		%>
				...
				<div style="padding:20px" class="Apartado" id="Apartado<%=y+1 %>">
