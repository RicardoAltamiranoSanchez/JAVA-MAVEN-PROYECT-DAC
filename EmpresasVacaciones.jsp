...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'combo',id:'IdEmpresasGrupo',name:'IdEmpresasGrupo',value:'',placeholder:'<%=idiomaModulo.getProperty("IdEmpresasGrupo") %>',label:'<%=idiomaModulo.getProperty("IdEmpresasGrupo") %>',required:true,options:[],yCount:'3'},
	{view:'text',id:'Ao',name:'Ao',value:'',placeholder:'<%=idiomaModulo.getProperty("Ao")%>',label:'<%=idiomaModulo.getProperty("Ao")%>',required:true},
	{view:'text',id:'DiasLey',name:'DiasLey',value:'',placeholder:'<%=idiomaModulo.getProperty("DiasLey")%>',label:'<%=idiomaModulo.getProperty("DiasLey")%>',required:true},
	{view:'text',id:'DiasExtra',name:'DiasExtra',value:'',placeholder:'<%=idiomaModulo.getProperty("DiasExtra")%>',label:'<%=idiomaModulo.getProperty("DiasExtra")%>',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'toolbar',id:'TablaTools',cols:[{view:'button',value:etiquetaBorrar,width:85,click:'borrar'},{view:'button',value:etiquetaModificar,width:85,click:'consultar'}]},{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,columns:[
	{id:'IdEmpresasGrupo',header:'<%=idiomaModulo.getProperty("IdEmpresasGrupo")%>',fillspace:true,sort:'string'},
	{id:'Ao',header:'<%=idiomaModulo.getProperty("Ao")%>',sort:'string'},
	{id:'DiasLey',header:'<%=idiomaModulo.getProperty("DiasLey")%>',sort:'string'},
	{id:'DiasExtra',header:'<%=idiomaModulo.getProperty("DiasExtra")%>',sort:'string'}]}]};
var vacio={id:'Vacio'};
