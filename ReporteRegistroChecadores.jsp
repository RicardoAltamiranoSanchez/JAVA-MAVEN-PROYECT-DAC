...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'combo',id:'NumEmpleado',name:'NumEmpleado',value:'',placeholder:'Numero de Empleado',label:'Numero de Empleado',labelPosition:'top',required:false,hidden:true,options:[],yCount:'3'},
	...
	/* {view:'combo',id:'Estacion',name:'Estacion',value:'',placeholder:'Estacion',label:'Estacion',labelPosition:'top',required:false,options:[],yCount:'3'}, */
	{view:'text',id:"Estacion",name:"Estacion",value:'',placeholder:'Ingrese una Estación si desea activar el filtrado', required:false},
...
{view:'toolbar',id:'TablaTools',cols:[
	...
	//{id:'NumEmpleado',header:'Numero de Empleado',width:100,sort:'string'},
	{id:'UsuarioIntranet',header:'Cuenta de Intranet',width:180,sort:'string'},
	{id:'log',header:'Nombre',width:310,sort:'string'},
	{id:'TipoRegistro',header:'Evento',width:120,sort:'string'},
	{id:'FechaHora',header:'Momento',width:160,sort:'string'},
	//{id:'value',header:'Registro',width:300,sort:'string'},
	{id:'Estacion',header:'Estacion',sort:'string'}
]}]};
var vacio={id:'Vacio'};
...
//estos 2 NO SE USAN
var listaNumEmpleado = $$("NumEmpleado").getPopup().getList();listaNumEmpleado.clearAll();listaNumEmpleado.load("RegistroChecadoresServlet.jsp?Accion=getRegistroChecadoresNumEmpleados&filter[value]=");
var listaEstacion = $$("Estacion").getPopup().getList();listaEstacion.clearAll();listaEstacion.load("RegistroChecadoresServlet.jsp?Accion=getRegistroChecadoresEstaciones&filter[value]=");
...
function excel(){
	...
	if (FechaInicio == null){
		...
		document.location = 'ReporteRegistroChecadoresExcel.jsp?Accion=Guardar' +
				'&AuxFecha=' + $$('AuxFecha').getValue() + 
				'&Fecha=' + $$('Fecha').getValue() + 
				'&FechaA=' + $$('FechaA').getValue() +
				'&NumEmpleado=' + $$('NumEmpleado').getValue() +
