...
var servlet='FormatosSeguridadServlet.jsp';
...
var forma={view:'form',id:'Forma',width:700,height:'100%',scroll:true,elements:[
	...
	{view:'uploader',id:'Archivo',name:'Archivo',value:'',link:'mylistArchivo',placeholder:Archivo,label:Archivo,upload:'SubirFormatosSeguridadServlet.jsp',autosend:true,required:true,multiple:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Archivo',header:'Archivo',fillspace:true,sort:'string',minWidth:150,template:'<a href="formatosSeguridad/#Archivo#" target="#Archivo#">#Archivo#</a>'},
...
function cargaEmpleados(){$$('IdsUsuariosLectura').load('servlet/EmpleadosServlet?Accion=getUsuariosDivSeguridad&filter[value]=');}
