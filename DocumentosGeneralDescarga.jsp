...
var servlet='DocumentosGeneralServlet.jsp';
...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	...
	{view:'uploader',id:'Archivo',name:'Archivo',value:'',link:'mylistArchivo',placeholder:Archivo,label:Archivo,upload:'SubirDocumentosGeneralServlet.jsp',autosend:true,required:true,multiple:false},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Archivo',header:'Archivo',fillspace:true,sort:'string',minWidth:150,template:'<a href="documentosGeneral/#Archivo#" target="#Archivo#">#Archivo#</a>'},
	{id:'Titulo',header:Titulo,sort:'string',width:150},
...
inicial();ultimosCapturados(ultimos5);buscar();
</script>
