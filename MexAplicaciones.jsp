...
<script>
//var servlet='servlet/MexAplicacionesServlet';
var servlet='MexAplicacionesServlet.jsp';
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Aplicacion',header:Aplicacion,fillspace:true,sort:'string',minWidth:150}
]}]};
var vacio={id:'Vacio'};
