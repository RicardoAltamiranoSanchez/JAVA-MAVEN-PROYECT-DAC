...
function guardar(){$$('Confirmacion').clearAll();$$('Forma').setValues({Accion:'ConsultarVacacionesEmpleados'},true); if($$('Forma').validate()) { enviar(registroGuardado,'Guardar'); $$('Confirmacion').show();}}
...
function buscar(){$$('Forma').setValues({Accion:'ConsultarVacacionesEmpleados'},true);enviar(busquedaFinalizada,'Buscar');}
