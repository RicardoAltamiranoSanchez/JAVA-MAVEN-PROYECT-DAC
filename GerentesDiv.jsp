...
var listaIdGerente = $$("IdGerente").getPopup().getList();listaIdGerente.clearAll();listaIdGerente.load("servlet/GerentesServlet?Accion=getUsuariosDiv&filter[value]=");
inicial();
</script>
