...
var forma={view:'form',id:'Forma',width:500,scroll:'y',height:'100%',elements:[
	...
	{view:'combo',id:'IdAreasLaborales',name:'IdAreasLaborales',value:'',placeholder:'ÁREA LABORAL',label:'ÁREA LABORAL',required:false,hidden:true,options:[],yCount:'3'},
	...
	{view:'textarea',id:'Observaciones',name:'Observaciones',value:'',placeholder:'OBSERVACIONES',label:'OBSERVACIONES',labelWidth:80,hidden:true,labelPosition:'top',height:100},
