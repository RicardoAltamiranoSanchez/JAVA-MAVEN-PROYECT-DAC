...
<script>
//var servlet='servlet/MexProveedoresServlet';
var servlet='MexProveedoresServlet.jsp';
var nada='';var valoresBusqueda='';var idGenerado='';var archivo='MexProveedoresDoc.jsp';var modoSubforma=true;
...
var NumeroExterior = 'Num.Ext.';
var NumeroInterior = 'Num.Int.';
var Colonia = 'Colonia';
var CodigoPostal = 'C.P.';
var Telefono = 'Telefono';
var Ciudad = 'Ciudad';
var Estado = 'Estado';
var Pais = 'Pais';
var GiroEmpresa = 'Giro Empresa';
var SitioInternet = 'Sitio Internet';
var Contacto = 'Contacto';
var Extension = 'Extension';
var Celular = 'Celular';
var Email = 'Email';
var DaCredito = 'Da Credito';
var DiasCredito = 'Dias de Credito';
var Banco1 = 'Banco';
var CuentaBancaria1 = 'Cuenta Bancaria';
var Clabe1 = 'Clabe Interbancaria';
var Moneda1 = 'Moneda';
var Banco2 = 'Banco 2';
var CuentaBancaria2 = 'Cuenta Bancaria 2';
var Clabe2 = 'Clabe 2';
var Moneda2 = 'Moneda 2';
var Estatus = 'Estatus';
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Alias',header:Alias,width:80},
	{id:'Nombre',header:Nombre,sort:'string',fillspace:true,sort:'string',minWidth:150},
	{id:'Telefono',header:Telefono,sort:'string',width:100},
	{id:'Contacto',header:Contacto,sort:'string',width:150},
	{id:'Email',header:Email,sort:'string',width:150},
	{id:'Estatus',header:Estatus,sort:'string',width:80}
]}]};
var vacio={id:'Vacio'};

webix.ui({id:'principal',type:'space',rows:[{view:'toolbar',cols:[{},{view:'button',id:'BotonBorrar',value:etiquetaBotonBorrar,width:85,click:'borrar'},{view:'text',id:'CampoBuscar',name:'CampoBuscar',value:'',placeholder:etiquetaBotonBuscar,width:300},{view:'button',id:'BotonBuscar',value:etiquetaBotonBuscar,width:85,click:'buscar'}]},{view:'accordion',type:'wide',multi:true,height:'100%',cols:[{header:'FORMA DE CAPTURA',body:forma},{body:tabla}]}]});
