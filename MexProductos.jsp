...
<script>
//var servlet='servlet/MexProductosServlet';
var servlet='MexProductosServlet.jsp';
...
var Producto = 'Producto / Servicio'.toUpperCase();
var Descripcion = 'Descripcion'.toUpperCase();

var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	{view:'text',id:'Producto',name:'Producto',value:'',placeholder:Producto,label:Producto,labelWidth:140,labelPosition:'left',required:true},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	{id:'Producto',header:Producto,sort:'string',width:250},
