...
<% boolean modoForma = true; boolean reporte = false; %>
<script>
...
var listaFacturarA = $$("FacturarA").getPopup().getList();listaFacturarA.clearAll();listaFacturarA.load("servlet/EmpresasGrupoServlet?Accion=getEmpresasGrupo&filter[value]=");
