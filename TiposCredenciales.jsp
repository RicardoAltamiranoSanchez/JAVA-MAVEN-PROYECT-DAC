...
var forma={view:'form',id:'Forma',width:400,height:'100%',enctype:"multipart/form-data",elements:[
	...
	{view:'uploader',id:'Imagen',name:'Archivo',value:'',link:'mylist',placeholder:'<%=idiomaModulo.getProperty("Archivo") %>',label:'<%=idiomaModulo.getProperty("Archivo") %>',required:true,upload:'servlet/SubirTiposCredencialesServlet',autosend:true,multiple:false},
...
var vacio={id:'Vacio'};
webix.ui({id:'principal',type:'space',rows:[{type:'header', template:'TIPOSCREDENCIALES'},{view:'accordion',type:'wide',multi:true,height:'100%',cols:[{header:' ',body:forma},{animate:{type:'flip'},cells:[vacio,lista,tabla]}]}]});	
