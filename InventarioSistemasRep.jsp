...
var forma={view:'form',id:'Forma',elements:[
	...
	{rows:[
		...
		{view:'textarea',id:'Reparacion',name:'Reparacion',value:'',placeholder:Reparacion,label:Reparacion,labelWidth:100,labelPosition:'left',height:100,required:true},
	]},
...
var tabla={id:'PanelTabla',height:'100%',rows:[{view:'datatable',id:'Tabla',width:'100%',select:'row',multiselect:true,resizeColumn:true,columns:[
	...
	{id:'Reparacion',header:Reparacion,sort:'string',fillspace:true,sort:'string',minWidth:150}
]}]};
var vacio={id:'Vacio'};
...
$$('Tabla').attachEvent('onAfterSelect',function(id){$$('Forma').setValues({
	...
	Reparacion: $$('Tabla').getItem(id).Reparacion,
...
$$('Reparacion').attachEvent('onChange',function(nuevo,anterior){nuevo=nuevo.toUpperCase();$$('Reparacion').setValue(nuevo);});

inicial();buscar();
</script>
<%} catch(NullPointerException e) { }
out.println(EncabezadoPie.getPie());
//InventarioSistemasRep.jsp
%>
