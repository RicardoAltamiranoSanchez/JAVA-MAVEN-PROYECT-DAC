...
<script>
//var servlet='servlet/MexRegistroDocumentacionServlet';
var servlet='MexRegistroDocumentacionServlet.jsp';
...
webix.ui({id:'principal',type:'space',rows:[{view:'toolbar',cols:[{view:'label',label:'Registro Documentacion'},{},{view:'button',id:'BotonBorrar',value:etiquetaBotonBorrar,width:85,click:'borrar',hidden:true},{view:'text',id:'CampoBuscar',name:'CampoBuscar',value:'',placeholder:etiquetaBotonBuscar,width:300,hidden:true},{view:'button',id:'BotonBuscar',value:etiquetaBotonBuscar,width:85,click:'buscar',hidden:true}]},{view:'accordion',type:'wide',multi:true,height:'100%',cols:[{body:tabla},{header:' ',body:forma}]}]});
