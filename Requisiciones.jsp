...
var nada='';var valoresBusqueda='';var idGenerado='';var archivo='RequisicionesAplicacion.jsp';var archivo1='RequisicionesArchivos.jsp';var archivo2='RequisicionesDatosFactura.jsp';var modoSubforma=true;
	...
	{header:"GENERAL",body:{view:'form',id:'Forma',width:700,elements:[
		...
		{cols:[
			...
			{rows:[
				...
				{},
				//{view:'datepicker',id:'FacturaFechaIdealPago',name:'FacturaFechaIdealPago',value: new Date(),placeholder:FacturaFechaIdealPago,width:210,label:FacturaFechaIdealPago,labelWidth:100,labelPosition:'top',stringResult:true,format:webix.Date.dateToStr('%Y-%m-%d'),required:true},
				{view:'datepicker',id:'FacturaFechaIdealPago',name:'FacturaFechaIdealPago',value: '',placeholder:FacturaFechaIdealPago,width:210,label:FacturaFechaIdealPago,labelWidth:100,labelPosition:'top',stringResult:true,format:webix.Date.dateToStr('%Y-%m-%d'),required:true},				
				{},
			]}
		]},
