...
var forma={view:'form',id:'Forma',width:400,height:'100%',elements:[
	...
	{view:'text',id:'Estacion',name:'Estacion',value:'MEX',hidden:true},
...
var listaIdRegistroEntradasAlmacenes = $$("IdRegistroEntradasAlmacenes").getPopup().getList();listaIdRegistroEntradasAlmacenes.clearAll();listaIdRegistroEntradasAlmacenes.load("RegistroEntradaVisitasAlmacenesServlet.jsp?Accion=getRegistroEntradasAlmacenesInactivos&filter[value]=,MEX");
